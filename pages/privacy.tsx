    ...
    <div className={styles.container}>
      ...
      <div className={pageStyles.page}>
        ...
        <div className={classes(pageStyles.contents, styles.privacy)}>
          <p>
            <b> 발효일: 2021년 2월 25일 (KST), 마지막 수정 : 2021년 2월 25일 (KST)</b>
          </p>
          <br></br>
          <p>
          ...
          <p>
            ...
            <br></br>
            토큰의 범위 : 계정 페이지에서 권한 부여를 하지 않는 한 고유 ID,
            프로필 이름, 프로필 사진 이외의 계정의 어느 정보에도 접근이
            불가능합니다.<br></br>
            계정 페이지에서 권한 부여를 할 때 토큰이 유효한 기간만 YouTube API에
            접근 권한이 생겨 영상의 자막, 제목 등을 업데이트할 수 있게 됩니다.{' '}
            <br></br>
            <b>
              주의: 토큰 권한 자체에는 영상을 업로드하고, 삭제하는 등의 관리할
              수 있는 권한이 포함되지만, 본 사이트에서는 해당 권한을 남용하여
              해당 기능을 사용하지 않음을 약속합니다.
            </b>
            <br></br>
            이를 투명하게 공개하기 위하여 사이트 소스 코드를 공개하고 있으며
