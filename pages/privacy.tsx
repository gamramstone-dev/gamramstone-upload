      ...
      <div className={pageStyles.page}>
        ...
        <div className={classes(pageStyles.contents, styles.privacy)}>
          ...
          <p>
            ...
            저장되는지 본 서비스를 이용하는 모든 이용자에게 알리기 위해
            작성되었습니다.
          </p>
          <br></br>
          <br></br>
          ...
          <p>
            ...
            행위) 방지 및 발생시 관계당국에 신고할 목적으로 수집하고 이외의
            목적으로는 사용하지 않습니다. 이러한 정보는 각 페이지 방문 및 API
            요청 시 수집되며, 수집 후 최대 7일 혹은 필요 시 목적 달성 후
            삭제됩니다.
            <br></br>이 정보는 Vercel Inc. 및 Better Stack에서 수집하며 이에
            관한 개인정보 처리방침은{' '}
          ...
          <p>
            ...
            됩니다. 토큰 정보란 Google 계정 비밀번호 대신 사용하는 문자로,
            Google 서비스의 한정된 정보 (본 서비스에서는 YouTube 서비스) 에만
            접근할 수 있도록 Google에서 서비스 제공자에게 발급하는 것을
            의미합니다.
            <br></br>
            <br></br>
            기본적으로 토큰은 발급 1시간 뒤에 자동으로 만료되며, 사이트에서 탈퇴
            혹은{' '}
            ...
            상태로 존재하게 됩니다. 암호화 상태 이전의 데이터는 오직 암호화 키를
